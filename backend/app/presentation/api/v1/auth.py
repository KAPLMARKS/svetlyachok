...
NB: `from __future__ import annotations` намеренно не используем — slowapi
оборачивает функцию декоратором, и FastAPI на Python 3.13 не успевает
резолвить ForwardRef в Pydantic-модели тела, из-за чего падает
/openapi.json и /login (см. https://github.com/tiangolo/fastapi/issues/...
и поведение pydantic 2.13 mock_val_ser).
"""
