...
|----------|------|----------|
| README | `README.md` | Landing page, быстрый старт, ссылки на детали |
| Начало работы | `docs/getting-started.md` | Установка, конфигурация, первый запуск |
| Архитектура (обзор) | `docs/architecture.md` | Структура слоёв, правила зависимостей |
| API Reference | `docs/api.md` | REST endpoints, формат ошибок RFC 7807 |
| Конфигурация | `docs/configuration.md` | Переменные окружения, секреты |
| Описание проекта | `.ai-factory/DESCRIPTION.md` | Полная спецификация системы |
| Архитектура (детали) | `.ai-factory/ARCHITECTURE.md` | Архитектурные решения, anti-patterns, примеры кода |
| Базовые правила | `.ai-factory/rules/base.md` | Стиль кода, именование, структура модулей |
| Backend README | `backend/README.md` | Команды установки, тестов, запуска backend |
